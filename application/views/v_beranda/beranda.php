...
<head>
    ...
    <link href="<?php echo base_url();?>assets/dist/img/pro1.png" rel="icon">
    ...
    <title>Homepage HalloRRI</title>
</head>

<body>
    <!-- Navbar -->
    <nav class="navbar navbar-expand-md navbar-light bg-light sticky-top">
    <img class="navbar-brand" src="<?= base_url('assets') ?>/dist/img/pro1.png" width="120" height="90">
    ...
    <div class="jumbotron" id="jumbotron">
        <div class="jumbotron-text d-flex flex-column justify-content-center align-items-center">
            <h1 tabindex="0" class="display-4 p-4 fw-bold">Selamat Datang <br>Di <span>Hallo</span>RRI PRO 1</h1>
            <p tabindex="0" class="lead border-3 border-top border-light">Suara Informasi, Inspirasi, dan Inovasi</p>
        </div>
    </div>
        ...
        <div class="container py-5">
            <div class="row g-4 py-2">
                <div class="col-md-6 hidden fade-left">
                    <h2 tabindex="0" class="pb-2">Apa itu website Hallo<span>RRI</span>?</h2>
                    <p tabindex="0">HALLO RRI adalah program siaran interaktif yang diselenggarakan oleh Radio Republik Indonesia (RRI), 
                        khususnya melalui kanal Pro 1. Program ini berfungsi sebagai wadah bagi publik untuk menyampaikan keluhan atau pertanyaan
                         terkait pelayanan publik di tingkat lokal, yang kemudian langsung direspon oleh pihak terkait. 
                        </p>

                    <p tabindex="0">Program ini telah mendapatkan apresiasi dari berbagai pihak, termasuk Ombudsman RI Perwakilan Maluku, 
                        karena perannya dalam menampung aspirasi masyarakat dan mendorong perbaikan pelayanan publik.</p>
                </div>
                <div class="col-md-6 hidden text-center fade-right">
                    <img class="about-image mx-auto" src="<?= base_url('assets') ?> /dist/img/rri.png" alt="About Image">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-5" id="content-2">
        <div class="container pb-4">
            <h3 tabindex="0" class="text-center py-5 fw-bold"style="color: white;">Alur Pengaduan</h3>
            <div class="row row-cols-2 row-cols-xs-3 row-cols-lg-5 g-4 text-center">
                <div class="col-sm hidden fade-up">
                    <div tabindex="0" class="box mx-auto hover-able">
                        ...
                        <h5 class="fw-bold"style="color: white;">Daftar/Masuk</h5>
                        <p style="color: white;"> Daftar/Masuk terlebih
                ...
                <div class="col-sm hidden fade-down">
                    <div tabindex="0" class="box mx-auto hover-able">
                        ...
                        <h5 class="fw-bold"style="color: white;">Tulis Laporan</h5>
                        <p style="color: white;"> Laporkan keluhan atau
                            aduan Anda dengan
                            jelas dan lengkap</p>
                    </div>
                </div>
                ...
                <div class="col-sm hidden fade-up">
                    <div tabindex="0" class="box mx-auto hover-able">
                        ...
                        <h5 class="fw-bold"style="color: white;">Tindak Lanjut</h5>
                        <p style="color: white;"> Laporan Anda akan
                ...
                <div class="col-sm hidden fade-down">
                    <div tabindex="0" class="box mx-auto hover-able">
                        ...
                        <h5 class="fw-bold"style="color: white;">Tanggapan</h5>
                        <p style="color: white;"> Anda akan mendapatkan
                ...
                <div class="col-sm hidden fade-up">
                    <div tabindex="0" class="box mx-auto hover-able">
                        ...
                        <h5 class="fw-bold" style="color: white;">Selesai</h5>
                        <p style="color: white;"> Laporan Anda akan terus
    ...
    <section class="py-5" id="content-4">
        <div class="container-lg pb-4">
            <h3 tabindex="0" class="text-center py-4 fw-bold"style="color: white;">Galeri</h3>
    ...
    <div class="text-center">
        <img src="<?= base_url('assets') ?>/dist/img/pro1.png" alt="logo image">
    </div>
    ...
    <section class="py-5" id="content-1">
        <div class="container py-5">
            <div class="row g-4 py-2 align-items-center">
                <!-- Kolom Teks -->
                <div class="col-12 col-md-6 hidden fade-left text-md-start text-center">
                    <h2 tabindex="0" class="pb-2">Animasi Hallo <span>RRI</span>?</h2>
                    <p tabindex="0">Mau tahu lebih jelas? Tonton videonya sekarang dan dapatkan informasinya langsung di HALLO RRI!</p>
                </div>
                <!-- Kolom Video -->
                <div class="col-12 col-md-6 hidden text-center fade-right">
                    <div class="ratio ratio-16x9">
                        <iframe src="https://www.youtube.com/embed/QrvPAGEz97w?si=II-suEGlwbOFAbQf" 
    ...
    <!-- Daftar Pelayanan Pengaduan -->
    <section class="pl" id="pelayan">
        <div class="container py-l">
            <div class="row">
                <div class="col-12 text-center">
                    <h3 tabindex="0"style="color: white;">Jam Pelayanan Pengaduan</h3>
                    <p tabindex="0"style="color: white;">Pelayanan Pengaduan kami tersedia pada jam berikut:</p>
                    <ul class="list-unstyled">
                        <li style="color: white;"><strong>Senin - Jumat:</strong> 09:00 - 10:00 WIB</li>
                        <li style="color: white;"><strong>Sabtu dan Minggu:</strong> Tutup</li>
                    </ul>
                    <p style="color: white;">Silakan ajukan pengaduan Anda pada jam operasional di atas.</p>
                </div>
            </div>
            <!-- Gambar Pelayanan -->
            <div class="row justify-content-center">
                <div class="col-12 col-md-8">
                    <img src="<?= base_url('assets') ?>/dist/img/OIP.jpg" alt="Gambar Pelayanan" class="img-fluid rounded-3 shadow-lg" style="color: white;"</style>>
                </div>
            </div>
        </div>
    </section>
